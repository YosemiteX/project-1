<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DuyuruDetay.aspx.cs" Inherits="BykMedya.UI.DuyuruDetay" %>
						...
						<div class="row">
							<div class="col-md-12">
								<ul class="breadcrumb">
									...
									<li class="active">Duyuru Başlığı</li>
								</ul>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<h1>Duyurunun Başlığı</h1>
							</div>
						</div>
					</div>
				</section>
							...
							<div class="blog-posts single-post">
								...
								<article class="post post-large blog-single-post">
										...
										<div data-plugin-options='{"items":1}'>
											<div>
												<div class="img-thumbnail">
													<img class="img-responsive" style="width:837px;height:327px;" src="img/Duyurular/indir (1).jpg" alt="">
												</div>
											</div>
									...
									<div class="post-content">
										...
										<h2><a>Class aptent taciti sociosqu ad litora torquent</a></h2>
